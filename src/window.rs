...
impl App for Wawa {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            egui::Window::new("wawa containment chamber").max_size([500.0,500.0]).show(ctx, |ui| {
                let wawa = egui::Image::new(egui::include_image!("../assets/icon.png")).max_size([25.0,25.0].into());
                let wawabutton = egui::ImageButton::new(wawa);
                //ui.add(wawabutton.clone());
